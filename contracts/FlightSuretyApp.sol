...
contract FlightSuretyApp {
    ...
    */
                                ...
                                public 
    {
        ...
        flightSuretyData = IFlightSuretyData(contractAddr);
    }
    ...
    /********************************************************************************************/
    /**
    * @dev Modifier that requires the account must have funded at least 10 ETH
    */
    modifier requireIsAirlineActive()
    {
        require(flightSuretyData.isActived(msg.sender), "The airline is not actived because the account must have funded at least 10 ETH.");
        _;
    }

    modifier requireAirlineNotVoted(address airlineAddress) {
        bool isVoted = false;
        for (uint256 index = 0; index < voters[airlineAddress].length; index++) {
            if (voters[airlineAddress][index] == msg.sender) {
                isVoted = true;
                break;
            }
        }

        require(!isVoted, "This airline was voted.");
        _;
    }
    ...
    */   
    function registerAirline
                            ...
                            returns(bool)
    {
        bool isResult = flightSuretyData.registerAirline(airlineAddress, airlineName);
        if (isResult) {
            voters[airlineAddress].push(msg.sender);
        }
    ...
    */  
                                ...
                                requireIsAirlineActive
    {
        ...
        require(!flights[key].isRegistered, "The flight is registered.");
    ...
    */  
    function processFlightStatus
                                ...
                                requireIsOperational
    {
        bytes32 key = keccak256(abi.encodePacked(flightID, airline));
        require(flights[key].isRegistered, "The flight is registered.");
...
contract IFlightSuretyData {
    ...
    function registerAirline(address airlineAddress, string calldata airlineName) external returns(bool);
